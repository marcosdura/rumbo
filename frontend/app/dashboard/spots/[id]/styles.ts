...
export const s = {
  ...
  input: { width: "100%", padding: "9px 12px", borderRadius: 10, border: "1px solid var(--border)", fontSize: 14, fontFamily: "inherit", boxSizing: "border-box" as const, background: "#fff" },
  tab: (active: boolean) => ({
